    ...
    <div class="col-md-12 d-flex align-items-stretch grid-margin">
        <div class="row flex-grow">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Detail <b>{{$transaction->kode_transaksi}}</b></h4>
                        <div class="form-group">
                            <div class="col-md-6">
                                <img width="200" height="200" @if($transaction->books->cover)
                                src="{{ asset('storage/'.$transaction->books->cover) }}" @endif />
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="kode_transaksi" type="text" class="form-control" name="kode_transaksi"
                                    value="{{$transaction->kode_transaksi}}" required readonly="">
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tgl_pinjam" type="date" class="form-control" name="tgl_pinjam"
                                    value="{{ date('Y-m-d', strtotime($transaction->tgl_pinjam)) }}" readonly="">
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tgl_kembali" type="date" class="form-control" name="tgl_kembali"
                                    value="{{ date('Y-m-d', strtotime($transaction->tgl_kembali)) }}" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="anggota_nama" type="text" class="form-control" readonly=""
                                    value="{{$transaction->members->nama}}">
                        ...
                        <div class="form-group{{ $errors->has('ket') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ket" type="text" class="form-control" name="ket"
                                    value="{{ $transaction->ket }}" readonly="">
                            </div>
                        </div>
