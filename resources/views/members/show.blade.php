    ...
    <div class="col-md-12 d-flex align-items-stretch grid-margin">
        <div class="row flex-grow">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Detail <b>{{$member->nama}}</b></h4>
                        <form class="forms-sample">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <img class="product" width="200" height="200" @if($member->user->gambar)
                                    src="{{ asset('storage/'.$member->user->gambar) }}" @endif />
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="npm" type="number" class="form-control" name="npm"
                                        value="{{ $member->npm }}" maxlength="8" readonly>
                                    @if ($errors->has('npm'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('tgl_lahir') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="tgl_lahir" type="text" class="form-control" name="tgl_lahir"
                                        value="{{ date('d F Y', strtotime($member->tgl_lahir)) }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="jk" required="" disabled="">
                                        <option value=""></option>
                                        <option value="L" {{$member->jk === "L" ? "selected" : ""}}>Laki - Laki</option>
                                        <option value="P" {{$member->jk === "P" ? "selected" : ""}}>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="prodi" required="" disabled="">
                                        <option value=""></option>
                                        <option value="TI" {{$member->prodi === "TI" ? "selected" : ""}}>Teknik
                                            Informatika</option>
                                        <option value="SI" {{$member->prodi === "SI" ? "selected" : ""}}>Sistem
                                            Informasi
                                        </option>
                                        <option value="KM" {{$member->prodi === "KM" ? "selected" : ""}}>Kesehatan
                                            Masyarakat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <a href="{{route('members.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                </div>
            </div>
        </div>
